...
# """
# Auth: Faiza Samreen
# This code is written as part of the EPSRC funded project "Models in the Cloud",
# Basic code and step through instructions are taken from
# http://www2.mmm.ucar.edu/wrf/OnLineTutorial/compilation_tutorial.php
#The script will install all the WRF dependencies and libraries for to run WRF.
# WRF version = 3.9.1.1 and WPS version = 3.9.1.1
# """
